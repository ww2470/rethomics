...
#' @param time_window_length The number of seconds to be used by the motion classifier. This corresponds to the period of the output data.
...
NULL
#' Define whether an animal is moving according to its subpixel velocity. 
...
NULL
#' Define whether an animal is moving. This is achieved by computing the number of crossed of
#' a "virtual beam" in the middle of the ROI (i.e. at x=0.5).
