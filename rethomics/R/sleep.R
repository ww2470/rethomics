...
#' @return A data table similar to \code{data} with additionnal variables/annotations (i.e. `moving', `asleep').
...
#' It requieres a variable named \code{xy_dist_log10x1000} in the .db file.
