stat_ld_annotationsw <- function (mapping = NULL,
                                data = NULL,
                                position = "identity",
...
#s <- load("../bak/sleep_sexual_dimorphism.RData")
ggetho(asleep, sleep_sexual_dimorphism,aes(t, asleep)) +stat_ld_annotationsw()
